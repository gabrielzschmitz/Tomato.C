...
int play(char * file, char * volume, char * title){
    ...
    mpvCheckError(mpv_set_option(mpvCtx, "save-position-on-quit", MPV_FORMAT_FLAG, &quit));
    ...
    while(toggle == 1){
        ...
        if(tmpfile){
            ...
            if(strstr(line, "100")) save = 100;
            else if(strstr(line, "90")) save = 90;
            else if(strstr(line, "80")) save = 80;
            else if(strstr(line, "70")) save = 70;
            else if(strstr(line, "60")) save = 60;
            else if(strstr(line, "50")) save = 50;
            else if(strstr(line, "40")) save = 40;
            else if(strstr(line, "30")) save = 30;
            else if(strstr(line, "20")) save = 20;
            else if(strstr(line, "10")) save = 10;
            else save = 0;
