...
const KeyFunction DEFAULT_KEYS[] = {
  ...
  {'h', InputCursorLeft, NORMAL, SCENE_NOTES, "Notes (Normal)", "Move cursor left"},
  {'l', InputCursorRight, NORMAL, SCENE_NOTES, "Notes (Normal)", "Move cursor right"},
  {KEY_LEFT, InputCursorLeft, NORMAL, SCENE_NOTES, "Notes (Normal)", "Move cursor left"},
  {KEY_RIGHT, InputCursorRight, NORMAL, SCENE_NOTES, "Notes (Normal)", "Move cursor right"},
  {'x', InputDeleteChar, NORMAL, SCENE_NOTES, "Notes (Normal)", "Delete character"},
  {ESC, InputESC, NORMAL, SCENE_NOTES, "Notes (Normal)", "Exit to DEFAULT mode"},
  {CTRLC, InputESC, NORMAL, SCENE_NOTES, "Notes (Normal)", "Exit to DEFAULT mode"},
  ...
  {KEY_ENTER, InputCommit, NORMAL, SCENE_NOTES, "Notes (Normal)", "Confirm input"},
  {'i', SwitchToInsertMode, NORMAL, SCENE_NOTES, "Notes (Normal)", "Switch to INSERT mode"},
  {'a', SwitchToInsertModeAppend, NORMAL, SCENE_NOTES, "Notes (Normal)", "Append after cursor"},
  {'v', SwitchToVisualMode, NORMAL, SCENE_NOTES, "Notes (Normal)", "Enter VISUAL mode"},
  ...
  /* INSERT mode keys */
  {KEY_LEFT, InputCursorLeft, INSERT, SCENE_NOTES, "Notes (Insert)", "Move cursor left"},
  {KEY_RIGHT, InputCursorRight, INSERT, SCENE_NOTES, "Notes (Insert)", "Move cursor right"},
  {KEY_BACKSPACE, InputBackspace, INSERT, SCENE_NOTES, "Notes (Insert)", "Delete character before cursor"},
  {BACKSPACE, InputBackspace, INSERT, SCENE_NOTES, "Notes (Insert)", "Delete character before cursor"},
  {ENTER, InputCommit, INSERT, SCENE_NOTES, "Notes (Insert)", "Commit text input"},
  {'\r', InputCommit, INSERT, SCENE_NOTES, "Notes (Insert)", "Commit text input"},
  {KEY_ENTER, InputCommit, INSERT, SCENE_NOTES, "Notes (Insert)", "Commit text input"},
  {ESC, InputESC, INSERT, SCENE_NOTES, "Notes (Insert)", "Exit to NORMAL mode"},
  {CTRLC, InputESC, INSERT, SCENE_NOTES, "Notes (Insert)", "Exit to NORMAL mode"},
  {'v', SwitchToVisualMode, INSERT, SCENE_NOTES, "Notes (Insert)", "Enter VISUAL mode"},
  {-1, InputInsertChar, INSERT, SCENE_NOTES, NULL, NULL}, /* printable chars */

  /* VISUAL mode keys */
  {'h', InputCursorLeft, VISUAL, SCENE_NOTES, "Notes (Visual)", "Extend selection left"},
  {'l', InputCursorRight, VISUAL, SCENE_NOTES, "Notes (Visual)", "Extend selection right"},
  {KEY_LEFT, InputCursorLeft, VISUAL, SCENE_NOTES, "Notes (Visual)", "Extend selection left"},
  {KEY_RIGHT, InputCursorRight, VISUAL, SCENE_NOTES, "Notes (Visual)", "Extend selection right"},
  {'x', InputVisualDelete, VISUAL, SCENE_NOTES, "Notes (Visual)", "Delete selection"},
  {ENTER, InputCommit, VISUAL, SCENE_NOTES, "Notes (Visual)", "Confirm selection"},
  {'\r', InputCommit, VISUAL, SCENE_NOTES, "Notes (Visual)", "Confirm selection"},
  {KEY_ENTER, InputCommit, VISUAL, SCENE_NOTES, "Notes (Visual)", "Confirm selection"},
  {ESC, InputESC, VISUAL, SCENE_NOTES, "Notes (Visual)", "Exit to NORMAL mode"},
  {CTRLC, InputESC, VISUAL, SCENE_NOTES, "Notes (Visual)", "Exit to NORMAL mode"},
  {'a', InputSwitchToInsertFromVisual, VISUAL, SCENE_NOTES, "Notes (Visual)", "Insert after selection"},
  {'i', SwitchToInsertMode, VISUAL, SCENE_NOTES, "Notes (Visual)", "Switch to INSERT mode"},

  /* Scene-specific keybindings - Before ALL_SCENES keys */
  {'V', ToggleMoveMode, DEFAULT, SCENE_NOTES, "Notes (Default)", "Toggle move mode"},
  {'j', MoveNoteDownWrapper, DEFAULT, SCENE_NOTES, "Notes (Default)", "Move note down"},
  {'k', MoveNoteUpWrapper, DEFAULT, SCENE_NOTES, "Notes (Default)", "Move note up"},
  {KEY_DOWN, MoveNoteDownWrapper, DEFAULT, SCENE_NOTES, "Notes (Default)", "Move note down"},
  {KEY_UP, MoveNoteUpWrapper, DEFAULT, SCENE_NOTES, "Notes (Default)", "Move note up"},
  {'h', NotesPrevPage, DEFAULT, SCENE_NOTES, "Notes (Default)", "Previous page"},
  {KEY_LEFT, NotesPrevPage, DEFAULT, SCENE_NOTES, "Notes (Default)", "Previous page"},
  {'l', NotesNextPage, DEFAULT, SCENE_NOTES, "Notes (Default)", "Next page"},
  {KEY_RIGHT, NotesNextPage, DEFAULT, SCENE_NOTES, "Notes (Default)", "Next page"},
  {'h', PromoteNoteWrapper, DEFAULT, SCENE_NOTES, "Notes (Default)", "Promote note"},
  {KEY_LEFT, PromoteNoteWrapper, DEFAULT, SCENE_NOTES, "Notes (Default)", "Promote note"},
  {'l', DemoteNoteWrapper, DEFAULT, SCENE_NOTES, "Notes (Default)", "Demote note"},
  {KEY_RIGHT, DemoteNoteWrapper, DEFAULT, SCENE_NOTES, "Notes (Default)", "Demote note"},
  {'d', DeleteNoteAtNotes, DEFAULT, SCENE_NOTES, "Notes (Default)", "Delete note"},
  ...
  {'e', EditCurrentNote, DEFAULT, SCENE_NOTES, "Notes (Default)", "Edit current note"},
  {ENTER, ExitMoveMode, DEFAULT, SCENE_NOTES, "Notes (Default)", "Exit move mode"},
  {ENTER, ToggleTaskAtNotes, DEFAULT, SCENE_NOTES, "Notes (Default)", "Toggle task done"},
  ...
  {KEY_DOWN, SelectNextItem, DEFAULT, SCENE_MAIN_MENU, "Main Menu", "Select next item"},
  {KEY_UP, SelectPreviousItem, DEFAULT, SCENE_MAIN_MENU, "Main Menu", "Select previous item"},
  {KEY_RIGHT, SelectNextItem, DEFAULT, SCENE_MAIN_MENU, "Main Menu", "Select next item"},
  {KEY_LEFT, SelectPreviousItem, DEFAULT, SCENE_MAIN_MENU, "Main Menu", "Select previous item"},
  {'j', SelectNextItem, DEFAULT, SCENE_MAIN_MENU, "Main Menu", "Select next item"},
  {'k', SelectPreviousItem, DEFAULT, SCENE_MAIN_MENU, "Main Menu", "Select previous item"},
  {'l', SelectNextItem, DEFAULT, SCENE_MAIN_MENU, "Main Menu", "Select next item"},
  {'h', SelectPreviousItem, DEFAULT, SCENE_MAIN_MENU, "Main Menu", "Select previous item"},
  {ENTER, ExecuteMenuAction, DEFAULT, SCENE_MAIN_MENU, "Main Menu", "Execute menu action"},

  /* Preferences dialog — navigation */
  {KEY_UP, PrefsSelectPrev, DEFAULT, SCENE_PREFERENCES, "Preferences", "Select previous setting"},
  {'k', PrefsSelectPrev, DEFAULT, SCENE_PREFERENCES, "Preferences", "Select previous setting"},
  {KEY_DOWN, PrefsSelectNext, DEFAULT, SCENE_PREFERENCES, "Preferences", "Select next setting"},
  {'j', PrefsSelectNext, DEFAULT, SCENE_PREFERENCES, "Preferences", "Select next setting"},
  {'u', PrefsScrollUp, DEFAULT, SCENE_PREFERENCES, "Preferences", "Scroll up"},
  {'d', PrefsScrollDown, DEFAULT, SCENE_PREFERENCES, "Preferences", "Scroll down"},
  {KEY_LEFT, PrefsValueDown, DEFAULT, SCENE_PREFERENCES, "Preferences", "Decrease value"},
  {'h', PrefsValueDown, DEFAULT, SCENE_PREFERENCES, "Preferences", "Decrease value"},
  {KEY_RIGHT, PrefsValueUp, DEFAULT, SCENE_PREFERENCES, "Preferences", "Increase value"},
  {'l', PrefsValueUp, DEFAULT, SCENE_PREFERENCES, "Preferences", "Increase value"},
  ...
  {KEY_ENTER, PrefsEdit, DEFAULT, SCENE_PREFERENCES, "Preferences", "Edit value"},
  {'q', PrefsBack, DEFAULT, SCENE_PREFERENCES, "Preferences", "Close preferences"},
  {ESC, PrefsBack, DEFAULT, SCENE_PREFERENCES, "Preferences", "Close preferences"},
  {CTRLC, PrefsBack, DEFAULT, SCENE_PREFERENCES, "Preferences", "Close preferences"},

  /* Preferences stepper sub-dialog */
  {'h', StepperDecrement, DEFAULT, SCENE_PREFS_STEPPER, "Preferences", "Decrement value"},
  {KEY_LEFT, StepperDecrement, DEFAULT, SCENE_PREFS_STEPPER, "Preferences", "Decrement value"},
  {'l', StepperIncrement, DEFAULT, SCENE_PREFS_STEPPER, "Preferences", "Increment value"},
  {KEY_RIGHT, StepperIncrement, DEFAULT, SCENE_PREFS_STEPPER, "Preferences", "Increment value"},
  {'p', PrefsPreview, DEFAULT, SCENE_PREFS_STEPPER, "Preferences", "Preview setting"},
  {ENTER, StepperClose, DEFAULT, SCENE_PREFS_STEPPER, "Preferences", "Confirm and close"},
  {'\r', StepperClose, DEFAULT, SCENE_PREFS_STEPPER, "Preferences", "Confirm and close"},
  {KEY_ENTER, StepperClose, DEFAULT, SCENE_PREFS_STEPPER, "Preferences", "Confirm and close"},
  {'q', StepperClose, DEFAULT, SCENE_PREFS_STEPPER, "Preferences", "Cancel and close"},
  {ESC, StepperClose, DEFAULT, SCENE_PREFS_STEPPER, "Preferences", "Cancel and close"},
  {CTRLC, StepperClose, DEFAULT, SCENE_PREFS_STEPPER, "Preferences", "Cancel and close"},

  /* Preferences select sub-dialog */
  {'k', SelectPrevOption, DEFAULT, SCENE_PREFS_SELECT, "Preferences", "Select previous option"},
  {KEY_UP, SelectPrevOption, DEFAULT, SCENE_PREFS_SELECT, "Preferences", "Select previous option"},
  {'j', SelectNextOption, DEFAULT, SCENE_PREFS_SELECT, "Preferences", "Select next option"},
  {KEY_DOWN, SelectNextOption, DEFAULT, SCENE_PREFS_SELECT, "Preferences", "Select next option"},
  {'p', PrefsPreview, DEFAULT, SCENE_PREFS_SELECT, "Preferences", "Preview setting"},
  {ENTER, SelectApply, DEFAULT, SCENE_PREFS_SELECT, "Preferences", "Apply selection"},
  {'\r', SelectApply, DEFAULT, SCENE_PREFS_SELECT, "Preferences", "Apply selection"},
  {KEY_ENTER, SelectApply, DEFAULT, SCENE_PREFS_SELECT, "Preferences", "Apply selection"},
  {'q', SelectCancel, DEFAULT, SCENE_PREFS_SELECT, "Preferences", "Cancel selection"},
  {ESC, SelectCancel, DEFAULT, SCENE_PREFS_SELECT, "Preferences", "Cancel selection"},
  {CTRLC, SelectCancel, DEFAULT, SCENE_PREFS_SELECT, "Preferences", "Cancel selection"},

  /* General keybindings - DEFAULT mode, ALL_SCENES */
  {KEY_UP, ChangeSelectedItemLeft, DEFAULT, ALL_SCENES, "General", "Select previous item"},
  {'k', ChangeSelectedItemLeft, DEFAULT, ALL_SCENES, "General", "Select previous item"},
  {KEY_LEFT, ChangeSelectedItemLeft, DEFAULT, ALL_SCENES, "General", "Select previous item"},
  {'h', ChangeSelectedItemLeft, DEFAULT, ALL_SCENES, "General", "Select previous item"},
  {KEY_DOWN, ChangeSelectedItemRight, DEFAULT, ALL_SCENES, "General", "Select next item"},
  {'j', ChangeSelectedItemRight, DEFAULT, ALL_SCENES, "General", "Select next item"},
  {KEY_RIGHT, ChangeSelectedItemRight, DEFAULT, ALL_SCENES, "General", "Select next item"},
  {'l', ChangeSelectedItemRight, DEFAULT, ALL_SCENES, "General", "Select next item"},
  {ENTER, ExecuteMenuAction, DEFAULT, ALL_SCENES, "General", "Execute selected action"},
  {KEY_ENTER, ExecuteMenuAction, DEFAULT, ALL_SCENES, "General", "Execute selected action"},
  {'\n', ExecuteMenuAction, DEFAULT, ALL_SCENES, "General", "Execute selected action"},
  {'\r', ExecuteMenuAction, DEFAULT, ALL_SCENES, "General", "Execute selected action"},
  {' ', NextPanel, DEFAULT, ALL_SCENES, "General", "Switch panel focus"},
  {'s', SkipPomodoroStep, DEFAULT, POMODORO_SCENES, "Pomodoro", "Skip current step"},
  {'p', TogglePause, DEFAULT, POMODORO_SCENES, "Pomodoro", "Toggle pause/resume"},
  {CTRLR, OpenResetMenu, DEFAULT, POMODORO_SCENES, "Pomodoro", "Open reset menu"},
  ...
  {KEY_LEFT, SelectPrevButton, DEFAULT, ALL_SCENES, "General", "Select previous button"},
  {'h', SelectPrevButton, DEFAULT, ALL_SCENES, "General", "Select previous button"},
  {KEY_RIGHT, SelectNextButton, DEFAULT, ALL_SCENES, "General", "Select next button"},
  {'l', SelectNextButton, DEFAULT, ALL_SCENES, "General", "Select next button"},
  {ENTER, ExecuteButtonAction, DEFAULT, ALL_SCENES, "General", "Execute button action"},
  {'\r', ExecuteButtonAction, DEFAULT, ALL_SCENES, "General", "Execute button action"},
  {KEY_ENTER, ExecuteButtonAction, DEFAULT, ALL_SCENES, "General", "Execute button action"},
  ...
  {'k', NoiseSelectPrev, DEFAULT, SCENE_NOISE, "Noise", "Select previous track"},
  {KEY_UP, NoiseSelectPrev, DEFAULT, SCENE_NOISE, "Noise", "Select previous track"},
  {'j', NoiseSelectNext, DEFAULT, SCENE_NOISE, "Noise", "Select next track"},
  {KEY_DOWN, NoiseSelectNext, DEFAULT, SCENE_NOISE, "Noise", "Select next track"},
  ...
  {'l', SelectNextButton, DEFAULT, SCENE_CONTINUE, "Continue", "Select next button"},
  {'h', SelectPrevButton, DEFAULT, SCENE_CONTINUE, "Continue", "Select previous button"},
  {KEY_RIGHT, SelectNextButton, DEFAULT, SCENE_CONTINUE, "Continue", "Select next button"},
  {KEY_LEFT, SelectPrevButton, DEFAULT, SCENE_CONTINUE, "Continue", "Select previous button"},
  {ENTER, ExecuteButtonAction, DEFAULT, SCENE_CONTINUE, "Continue", "Execute button action"},
  {'\r', ExecuteButtonAction, DEFAULT, SCENE_CONTINUE, "Continue", "Execute button action"},
  {KEY_ENTER, ExecuteButtonAction, DEFAULT, SCENE_CONTINUE, "Continue", "Execute button action"},
  ...
  {'h', HistoryCursorLeft, DEFAULT, SCENE_HISTORY_OVERVIEW, "History", "Move cursor left"},
  {'l', HistoryCursorRight, DEFAULT, SCENE_HISTORY_OVERVIEW, "History", "Move cursor right"},
  {'j', HistoryCursorDown, DEFAULT, SCENE_HISTORY_OVERVIEW, "History", "Move cursor down"},
  {'k', HistoryCursorUp, DEFAULT, SCENE_HISTORY_OVERVIEW, "History", "Move cursor up"},
  {KEY_LEFT, HistoryCursorLeft, DEFAULT, SCENE_HISTORY_OVERVIEW, "History", "Move cursor left"},
  {KEY_RIGHT, HistoryCursorRight, DEFAULT, SCENE_HISTORY_OVERVIEW, "History", "Move cursor right"},
  {KEY_DOWN, HistoryCursorDown, DEFAULT, SCENE_HISTORY_OVERVIEW, "History", "Move cursor down"},
  {KEY_UP, HistoryCursorUp, DEFAULT, SCENE_HISTORY_OVERVIEW, "History", "Move cursor up"},
  {ENTER, HistoryOpenDayDetail, DEFAULT, SCENE_HISTORY_OVERVIEW, "History", "Open day detail"},
  {'\r', HistoryOpenDayDetail, DEFAULT, SCENE_HISTORY_OVERVIEW, "History", "Open day detail"},
  {'\t', HistoryOpenStatistics, DEFAULT, SCENE_HISTORY_OVERVIEW, "History", "Open statistics"},
  {'q', ClosePopup, DEFAULT, SCENE_HISTORY_OVERVIEW, "History", "Close history"},
  {ESC, ClosePopup, DEFAULT, SCENE_HISTORY_OVERVIEW, "History", "Close history"},
  {CTRLC, ClosePopup, DEFAULT, SCENE_HISTORY_OVERVIEW, "History", "Close history"},

  /* History Day Detail */
  {'j', HistoryScrollDown, DEFAULT, SCENE_HISTORY_DAY, "History", "Scroll session list down"},
  {'k', HistoryScrollUp, DEFAULT, SCENE_HISTORY_DAY, "History", "Scroll session list up"},
  {KEY_DOWN, HistoryScrollDown, DEFAULT, SCENE_HISTORY_DAY, "History", "Scroll session list down"},
  {KEY_UP, HistoryScrollUp, DEFAULT, SCENE_HISTORY_DAY, "History", "Scroll session list up"},
  {ENTER, HistoryCloseToOverview, DEFAULT, SCENE_HISTORY_DAY, "History", "Back to overview"},
  {'\r', HistoryCloseToOverview, DEFAULT, SCENE_HISTORY_DAY, "History", "Back to overview"},
  {CTRLC, HistoryCloseToOverview, DEFAULT, SCENE_HISTORY_DAY, "History", "Back to overview"},
  {ESC, HistoryCloseToOverview, DEFAULT, SCENE_HISTORY_DAY, "History", "Back to overview"},
  {'q', HistoryCloseToOverview, DEFAULT, SCENE_HISTORY_DAY, "History", "Back to overview"},

  /* History Statistics */
  {'\t', HistoryCloseToOverview, DEFAULT, SCENE_HISTORY_STATS, "History", "Back to overview"},
  {CTRLC, HistoryCloseToOverview, DEFAULT, SCENE_HISTORY_STATS, "History", "Back to overview"},
  {ESC, HistoryCloseToOverview, DEFAULT, SCENE_HISTORY_STATS, "History", "Back to overview"},
  {'q', HistoryCloseToOverview, DEFAULT, SCENE_HISTORY_STATS, "History", "Back to overview"},
